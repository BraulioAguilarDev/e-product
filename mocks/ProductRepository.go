...
func (_m *ProductRepository) Create(sku string, name string, price float64) (*model.Product, error) {
...
func (_m *ProductRepository) Get(id uuid.UUID) (*model.Product, error) {
	ret := _m.Called(id)
...
func (_m *ProductRepository) Update(product *model.Product) (*model.Product, error) {
